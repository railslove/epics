RSpec.describe Epics::CDB do
  ...
  describe 'H005 request structure' do
    ...
    include_examples 'a valid ebicsRequest H005 upload',
      service_name: 'SDD', msg_name: 'pain.008', service_option: 'B2B'
  end
  ...
  describe 'H004 request structure' do
    ...
    include_examples 'a valid ebicsRequest upload', order_type: 'CDB', order_attribute: 'OZHNN'
  end
  ...
  describe 'H003 request structure' do
    ...
    include_examples 'a valid ebicsRequest upload', order_type: 'CDB', order_attribute: 'OZHNN', ebics_version: 'H003'
  end
