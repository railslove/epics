RSpec.describe Epics::C2S do
  ...
  describe 'order attributes' do
    ...
    it { expect(subject.to_xml).to include('<OrderType>C2S</OrderType>') }
  end
  ...
  describe 'H004 request structure' do
    ...
    include_examples 'a valid ebicsRequest upload', order_type: 'C2S', order_attribute: 'DZHNN'
  end
  ...
  describe 'H003 request structure' do
    ...
    include_examples 'a valid ebicsRequest upload', order_type: 'C2S', order_attribute: 'DZHNN', ebics_version: 'H003'
  end
