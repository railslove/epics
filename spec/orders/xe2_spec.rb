RSpec.describe Epics::XE2 do
  ...
  describe 'H005 request structure' do
    ...
    include_examples 'a valid ebicsRequest H005 upload',
      service_name: 'MCT', msg_name: 'pain.001'
  end
  ...
  describe 'H004 request structure' do
    ...
    include_examples 'a valid ebicsRequest upload', order_type: 'XE2', order_attribute: 'OZHNN'
  end
  ...
  describe 'H003 request structure' do
    ...
    include_examples 'a valid ebicsRequest upload', order_type: 'XE2', order_attribute: 'OZHNN', ebics_version: 'H003'
  end
