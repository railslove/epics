RSpec.describe Epics::CDD do
  ...
  describe 'order attributes' do
    ...
    it { expect(subject.to_xml).to include('<OrderType>CDD</OrderType>') }
  end
  ...
  describe 'H004 request structure' do
    ...
    include_examples 'a valid ebicsRequest upload', order_type: 'CDD', order_attribute: 'OZHNN'
  end
  ...
  describe 'H003 request structure' do
    ...
    include_examples 'a valid ebicsRequest upload', order_type: 'CDD', order_attribute: 'OZHNN', ebics_version: 'H003'
  end
