RSpec.describe Epics::CCT do
  ...
  describe 'H004 request structure' do
    ...
    include_examples 'a valid ebicsRequest upload', order_type: 'CCT', order_attribute: 'OZHNN'
  end
  ...
  describe 'H003 request structure' do
    ...
    include_examples 'a valid ebicsRequest upload', order_type: 'CCT', order_attribute: 'OZHNN', ebics_version: 'H003'
  end
