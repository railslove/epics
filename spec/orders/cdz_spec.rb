  ...
  context 'with date range' do
    ...
    describe 'H005 request structure' do
      ...
      include_examples 'a valid ebicsRequest H005 download with date range',
        service_name: 'REP', msg_name: 'pain.002', scope: 'DE', service_option: 'SDD', from: '2014-09-01', to: '2014-09-30'
    end
    ...
    describe 'H003 request structure' do
      ...
      include_examples 'a valid ebicsRequest download with date range',
        order_type: 'CDZ', from: '2014-09-01', to: '2014-09-30', ebics_version: 'H003'
    end
  end
  ...
  context 'without date range' do
    ...
    describe 'H005 request structure' do
      ...
      include_examples 'a valid ebicsRequest H005 download',
        service_name: 'REP', msg_name: 'pain.002', scope: 'DE', service_option: 'SDD'
    end
    ...
    describe 'H004 request structure' do
      ...
      include_examples 'a valid ebicsRequest download', order_type: 'CDZ'
    end
    ...
    describe 'H003 request structure' do
      ...
      include_examples 'a valid ebicsRequest download', order_type: 'CDZ', ebics_version: 'H003'
    end
  end
end
