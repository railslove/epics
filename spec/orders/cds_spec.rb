RSpec.describe Epics::CDS do
  ...
  describe 'order attributes' do
    ...
    it { expect(subject.to_xml).to include('<OrderType>CDS</OrderType>') }
  end
  ...
  describe 'H005 request structure' do
    ...
    include_examples 'a valid ebicsRequest H005 upload',
      service_name: 'SDD', msg_name: 'pain.008', scope: 'BIL'
  end
  ...
  describe 'H004 request structure' do
    ...
    include_examples 'a valid ebicsRequest upload', order_type: 'CDS', order_attribute: 'DZHNN'
  end
  ...
  describe 'H003 request structure' do
    ...
    include_examples 'a valid ebicsRequest upload', order_type: 'CDS', order_attribute: 'DZHNN', ebics_version: 'H003'
  end
