RSpec.describe Epics::C52 do
  ...
  describe 'order attributes' do
    ...
    it { expect(subject.to_xml).to include('<OrderType>C52</OrderType>') }
  end
  ...
  describe 'H005 request structure' do
    ...
    include_examples 'a valid ebicsRequest H005 download with date range',
      service_name: 'STM', msg_name: 'camt.052', from: '2014-09-01', to: '2014-09-30'
  end
  ...
  describe 'H004 request structure' do
    ...
    include_examples 'a valid ebicsRequest download with date range',
      order_type: 'C52', from: '2014-09-01', to: '2014-09-30'
  end
  ...
  describe 'H003 request structure' do
    ...
    include_examples 'a valid ebicsRequest download with date range',
      order_type: 'C52', from: '2014-09-01', to: '2014-09-30', ebics_version: 'H003'
  end
end